...
## 📝 About The Project
Server-side application built with Express, MongoDB, managing core logic and database interactions.
...
1.  **Clone the repository**:
    ```bash
    git clone git@github.com:amitdubeyup/troopstop-backend.git
    ```
